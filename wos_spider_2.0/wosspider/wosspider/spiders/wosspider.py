...
class WosspiderSpider(CrawlSpider):
    ...
    start_urls = ['http://apps.webofknowledge.com/summary.do?product=UA&parentProduct=UA&search_mode=GeneralSearch&parentQid=&qid=93&SID=5DMyGYTActOeLsTocvB&&update_back2search_link_param=yes&page=2']
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow=r'.+full_record.do\?.+&qid=93.+&page=\d&doc=\d'), callback="parse_item", follow=True),
    )
