        ...
        try:
            ...
            if repetition and repetition2:
                ...
                self.cursor.execute(self.sql, (
                    item['wosnum'], item['title'], item['author'], item['author2'], item['reprintauthor'],
                    item['journal'],
                    ...
                    item['researchareas'], item['woscategories'], item['lang'], item['issn'], item['eissn'],
                    item['idsnum'],
                    item['refer'], item['cited'], item['url'], item['referarticles'], item['authorrefer'],
                    item['journalrefer'], item['othersrefer'], item['coauthors'], item['authorlistkey'], item['impact'],
                    item['authorid']))
                print('=' * 30)
                print('主表')
                self.conn.commit()
